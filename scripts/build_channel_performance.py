...
def main():
    ...
    # Affiliates' traffic keys are FirstPromoter promoter names (e.g. "Sascha",
    # "guru99.com" the site's own promoter account), not GA4's "source / medium"
    # strings — they'd never coincidentally match a domain-shaped Admin DB
    # Title, so Affiliates is excluded from this match entirely, same as
    # every other channel with no real Title counterpart.
